 ...
 * @author Antz
 */
class Unbxd_Search_Model_Catalog_Layer_Filter_Decimal extends Mage_Catalog_Model_Layer_Filter_Decimal
{
     ...
     * @return Unbxd_Search_Model_Catalog_Layer_Filter_Decimal
     */
     ...
     *
     * @param Unbxd_Search_Model_Catalog_Layer_Filter_Decimal $filter
     * @param int $range
     * @param int $index
     * @return Unbxd_Search_Model_Catalog_Layer_Filter_Decimal
     */
    ...
    {
        $fieldName = Mage::helper('unbxd_search')->getAttributeFieldName($this->getAttributeModel());
    ...
    protected function _renderItemLabel($range, $value)
    {
        ...
        $to = Zend_Locale_Format::toFloat($to, array('locale' => Mage::helper('unbxd_search')->getLocaleCode()));

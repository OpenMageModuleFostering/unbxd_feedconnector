 ...
 * @author Antz
 */
class Unbxd_Search_Model_Resource_Catalog_Product_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection
{
    /**
     * @var Unbxd_Search_Model_Resource_Engine_Abstract Search engine.
     */
    protected $_engine;
     ...
     *
     * @param Unbxd_Search_Model_Resource_Engine_Abstract $engine
     * @return Unbxd_Search_Model_Resource_Catalog_Product_Collection
     */
    public function setEngine(Unbxd_Search_Model_Resource_Engine_Abstract $engine)
    {
        $this->_engine = $engine;

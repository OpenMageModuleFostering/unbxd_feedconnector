 ...
 */
class Unbxd_Searchcore_Model_Field extends Mage_Core_Model_Abstract
{
     ...
     * @var array
     */
    public static $data_types = array(Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_TEXT, Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_LONGTEXT,
        Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_LINK, Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_NUMBER,
        Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_DECIMAL, Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_DATE);
    ...
    {
        $this->_init('unbxd_searchcore/field');
        Unbxd_Searchcore_Model_Field::$featurefields = $this->getFeaturedFields();
    ...
    public function saveFields($collection)
    {
        ...
        try {
            ...
            Mage::helper("unbxd_searchcore")->log(Zend_Log::ERR, "Saving fields failed because " . $e->getMessage());
	...
	*/
    public function getFeaturedFields()
    {
        ...
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_1_NAME] =
            $this->getField("text", "false", "false");
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_2_NAME] =
            $this->getField("text", "false", "false");
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_3_NAME] =
            $this->getField("text", "false", "false");
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_4_NAME] =
            $this->getField("text", "false", "false");
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_1] =
            $this->getField("text", "true", "false");
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_2] =
            $this->getField("text", "true", "false");
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_3] =
            $this->getField("text", "true", "false");
        $featuredFields[Unbxd_Searchcore_Model_Resource_Field::CAT_LEVEL_4] =
            $this->getField("text", "true", "false");
    ...
    {
        $priceFieldConfig =
            Mage::helper('unbxd_searchcore')->getEngineConfigData(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRICE);
        if (array_key_exists(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRICE, $priceFieldConfig)) {
            return $priceFieldConfig[Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRICE];
        }
        ...
        $priceField = $this->_getResource()->getFieldByFeatureField(Mage::app()->getWebsite()->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRICE);
        return $priceField;
    }
    ...
    public function setPriceFieldName(Mage_Core_Model_Website $website) {
        $priceName = $this->getResource()->getFieldByFeatureField($website->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRICE);
        Mage::helper('unbxd_searchcore')->saveConfig($website,
            array(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRICE => $priceName));
    }
    ...
    public function getImageUrlFieldName()
    {
        $imageUrlFieldName = $this->_getResource()->getFieldByFeatureField(Mage::app()->getWebsite()->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_IMAGE_URL);
    ...
    public function setImageUrlFieldName(Mage_Core_Model_Website $website)
    {
        $imageField = $this->getResource()->getFieldByFeatureField($website->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_IMAGE_URL);
        Mage::helper('unbxd_searchcore')->saveConfig($website,
            array(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_IMAGE_URL => $imageField));
    }
    ...
    public function getProductUrlFieldName()
    {
        $fieldConfig =
            Mage::helper('unbxd_searchcore')
                ->getEngineConfigData(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRODUCT_URL);
        if(array_key_exists(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRODUCT_URL, $fieldConfig)) {
            return $fieldConfig[Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRODUCT_URL];
        }
        $this->rebuildConfigCache(Mage::app()->getWebsite());
        $productUrl = $this->_getResource()->getFieldByFeatureField(Mage::app()->getWebsite()->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRODUCT_URL);
        return $productUrl;
    ...
    public function setProductUrlFieldName(Mage_Core_Model_Website $website)
    {
        $productUrlField = $this->getResource()->getFieldByFeatureField($website->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRODUCT_URL);
        Mage::helper('unbxd_searchcore')->saveConfig($website,
            array(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_PRODUCT_URL => $productUrlField));
    }
    ...
    public function getCategoryFieldName()
    {
        $fieldConfig =
            Mage::helper('unbxd_searchcore')
                ->getEngineConfigData(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_CATEGORY);
        if(array_key_exists(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_CATEGORY, $fieldConfig)) {
            return $fieldConfig[Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_CATEGORY];
        }
        $this->rebuildConfigCache(Mage::app()->getWebsite());
        $categoryField = $this->_getResource()->getFieldByFeatureField(Mage::app()->getWebsite()->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_CATEGORY);
    ...
    public function setCategoryFieldName(Mage_Core_Model_Website $website)
    {
        $categortField = $this->getResource()->getFieldByFeatureField($website->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_CATEGORY);
        Mage::helper('unbxd_searchcore')->saveConfig($website,
            array(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_CATEGORY => $categortField));
    }
    ...
    public function getBrandFieldName()
    {
        $fieldConfig =
            Mage::helper('unbxd_searchcore')
                ->getEngineConfigData(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_BRAND);
        if(array_key_exists(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_BRAND, $fieldConfig)) {
            return $fieldConfig[Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_BRAND];
        }
        $this->rebuildConfigCache(Mage::app()->getWebsite());
        $brandField = $this->_getResource()->getFieldByFeatureField(Mage::app()->getWebsite()->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_BRAND);
        return $brandField;
    }
    ...
    public function setBrandFieldName(Mage_Core_Model_Website $website)
    {
        $brandField = $this->getResource()->getFieldByFeatureField($website->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_BRAND);
        Mage::helper('unbxd_searchcore')->saveConfig($website,
            array(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_BRAND => $brandField));
    }
    ...
    public function getTitleFieldName()
    {
        $fieldConfig =
            Mage::helper('unbxd_searchcore')
                ->getEngineConfigData(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_TITLE);
        if(array_key_exists(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_TITLE, $fieldConfig)) {
            return $fieldConfig[Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_TITLE];
        }
        $this->rebuildConfigCache(Mage::app()->getWebsite());
        $titleField = $this->_getResource()->getFieldByFeatureField(Mage::app()->getWebsite()->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_TITLE);
        return $titleField;
    }
    ...
    public function setTitleFieldName(Mage_Core_Model_Website $website)
    {
        $titleField = $this->getResource()->getFieldByFeatureField($website->getWebsiteId(),
            Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_TITLE);
        Mage::helper('unbxd_searchcore')->saveConfig($website,
            array(Unbxd_Searchcore_Helper_Constants::FEATURE_FIELD_TITLE => $titleField));
    }

    public function getImageFields($website)
    {
        $conf = Mage::helper('unbxd_searchcore')->getEngineConfigData(Unbxd_Searchcore_Helper_Constants::FIELD_CONF, $website, true);
        $fieldConf = json_decode($conf[Unbxd_Searchcore_Helper_Constants::FIELD_CONF], true);
        ...
        foreach ($fieldConf as $field => $conf) {
            ...
            $imageFields[$field] = Mage::helper('unbxd_searchcore')->isConfigTrue($website, 'image_full') ? true : false;
        }
        return $imageFields;
    }
    ...
    {
        if ($unbxdDatatype == Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_TEXT || $unbxdDatatype == Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_LONGTEXT ||
            $unbxdDatatype == Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_LINK
        ) {
            return true;
        }
        if ($unbxdDatatype == Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_NUMBER && $magentoDatatype == Unbxd_Searchcore_Helper_Constants::FIELD_TYPE_NUMBER) {
            return true;
        }
        if ($unbxdDatatype == Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_DECIMAL && $magentoDatatype == Unbxd_Searchcore_Helper_Constants::FIELD_TYPE_NUMBER) {
            return true;
        }
        if ($unbxdDatatype == Unbxd_Searchcore_Helper_Constants::UNBXD_DATATYPE_DATE && $magentoDatatype == Unbxd_Searchcore_Helper_Constants::FIELD_TYPE_DATE) {
            return true;
        }
        return false;
    }

 ...
 * Time: 12:48 AM
 */
class Unbxd_Searchcore_Model_Feed_Feedconfig {
    var $page = 0;
    var $limit = -1;
    ...
    public function __construct(Mage_Core_Model_Website $website) {
        $this->_includeTaxonomyNodes = Mage::helper('unbxd_searchcore')
            ->isConfigTrue($website, Unbxd_Searchcore_Helper_Constants::INCLUDE_TAXONOMY_NODES);
        $this->_includeTaxonomyMapping = Mage::helper('unbxd_searchcore')
            ->isConfigTrue($website, Unbxd_Searchcore_Helper_Constants::INCLUDE_TAXONOMY_MAPPING);
    }

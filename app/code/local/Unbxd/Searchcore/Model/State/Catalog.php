...
class Unbxd_Searchcore_Model_State_Catalog implements Unbxd_Searchcore_Model_State {
	 ...
	 protected function _checkFeedUpload(Mage_Core_Model_Website $website) {
		...
		return !is_null($lastUploadTime);
          ...
          protected function _checkCron(Mage_Core_Model_Website $website) {
                 $cronFlag = Mage::getResourceModel('unbxd_searchcore/config')
                                 ->getValue($website->getWebsiteId(), Unbxd_Searchcore_Helper_Constants::IS_CRON_ENABLED);

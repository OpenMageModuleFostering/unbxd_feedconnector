...
class Unbxd_Searchcore_Model_State_Analytics implements Unbxd_Searchcore_Model_State {
	...
	protected function _checkRecommendorAnalytics(Mage_Core_Model_Website $website) {
		$analyticsImpression = Mage::getModel("unbxd_searchcore/api_task_analyticsimpression")
                	->prepare($website)
                	->process();
	...
	protected function _checkSearchAnalytics(Mage_Core_Model_Website $website) {
		$searchImpressions = Mage::getSingleton('unbxd_searchcore/api_task_searchimpression')
					->prepare($website)
					->process();

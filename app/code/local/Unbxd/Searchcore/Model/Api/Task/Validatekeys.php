 ...
 */
class Unbxd_Searchcore_Model_Api_Task_Validatekeys extends Unbxd_Searchcore_Model_Api_Task {
    ...
    protected function prepareParams() {
        ...
        if(!array_key_exists(static::SECRET_KEY, $params)) {
            ...
            $this->errors[Unbxd_Searchcore_Helper_Confighelper::SECRET_KEY] = "secret key expected";
        }
        if(!array_key_exists(static::SITE_KEY, $params)) {
            $this->preparationSuccessful = false;
            $this->errors[Unbxd_Searchcore_Helper_Confighelper::SITE_KEY] = "site key expected";
        }
